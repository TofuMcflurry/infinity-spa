        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {editingPersonal ? (
                        <input
                          ...
                          className="w-full bg-secondary/60 border border-glass-border rounded-xl px-3.5 py-2.5 text-sm outline-none focus:ring-1 focus:ring-primary/50 transition-colors"
                        />
                      ) : (
            ...
            <SectionCard delay={0.1}>
              ...
              {/* Apple Pay */}
              <div className="flex items-center justify-between p-4 bg-secondary/50 border border-glass-border rounded-xl mb-3">
              ...
              {/* Credit Card — styled like a mini card */}
              <div className="relative overflow-hidden p-4 rounded-xl border border-glass-border bg-gradient-to-br from-secondary to-muted mb-3">
              ...
              <button className="w-full flex items-center justify-center gap-2 p-3.5 rounded-xl border border-dashed border-glass-border text-sm text-muted-foreground hover:border-primary/40 hover:text-primary transition-colors">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <SectionCard delay={0.15}>
              ...
              <div className="space-y-3">
                {addresses.map((addr) => (
                  <div key={addr.label} className="flex items-center gap-3 p-3.5 bg-secondary/50 border border-glass-border rounded-xl">
            ...
            <SectionCard delay={0.25}>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3.5 bg-secondary/50 border border-glass-border rounded-xl">
                  <div>
