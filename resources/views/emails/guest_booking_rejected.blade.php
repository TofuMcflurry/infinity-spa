...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #fee2e2; color: #991b1b; border-radius: 999px; padding: 4px 16px; font-size: 13px; font-weight: 600; margin-bottom: 20px; }
...
<body>
    <div class="card">
        ...
        <div class="badge">❌ Booking Unavailable</div>

        <h2>We're sorry, {{ $booking->guest_name }}</h2>
        <p style="color:#6b7280; margin-top:0;">Unfortunately, we are unable to accommodate your booking request at this time.</p>
        ...
        <p style="font-size:14px;">We apologize for any inconvenience. We'd love to serve you — please feel free to book again for another date or time.</p>
